 function login(){
    axios.post("http://localhost:8080/users/login", {
        ...
        if (response.data === "Login successful"){
            ...
            redirectToLoginForm("http://localhost:63342/CS4-Blog-Management/src/main/resources/templates/test.html?_ijt=b9la6abauvvsqrbled8hm3dkue&_ij_reload=RELOAD_ON_SAVE")
